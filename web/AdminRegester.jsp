<%-- 
    Document   : AdminRegester
    Created on : Apr 18, 2019, 3:05:16 PM
    Author     : Felix-ITs
--%>
...
<html>
    ...
    <body>
        <form action="http://localhost:8080/OnlineExam/AdminRegister" method="post" style="background-image:url(wall.jpg);background-size: cover">
            <table align="center" style="background-color:pink">
                ...
                <tr>
                    ...
                    <td><input type="text" name="txtname" required="please enter username" placeholder="Username name" style="width: 250px; padding: 10px"></td><br><br>
                </tr>
                <tr>
